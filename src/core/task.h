...
//    friend class Tomato;
//private:
//    Task(Tomato *taskManager, Task *parent = 0);
//    Task(Tomato *taskManager, const TaskData &data, Task *parent = 0);
//public:
//    ~Task();

//    inline Tomato *taskManager() const;
//    inline Task *parent() const;
...
//    static Task *variantToPtr(const QVariant &task);
//private:
//    void init(Tomato *taskManager, const TaskData &data, Task *parent);

//    void calcTotalTaskTime();
//    void calcTotalSubTasksTime();
//    void calcTaskTime();

//    void cascadeUpdateTotalTaskTime();
//private:
//    Tomato *m_taskManager;
//    Task *m_parent;
